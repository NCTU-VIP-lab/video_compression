...
def main(**kwargs):
    ...
    for path in tqdm(paths):
        ...
        for j in range(iteration):
            ...
            reconstruction_frames, example, clip_flow_bpp, clip_res_bpp, clip_intra_bpp, clip_actual_bits = utils.sample_test_bidir(flow_AE, res_AE, MC_net, opt_res_AE, tmp_frames, tmp_ori, config_test, index, max_edge, criterion1, args.name)
