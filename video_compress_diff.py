...
def main(**kwargs):
    ...
    for path in tqdm(paths):
        ...
        for j in range(iteration):
            ...
            reconstruction_frames, example, clip_bpp, clip_actual_bits, clip_flow_bits, clip_res_bits = utils.sample_test_api_diff(flow_AE, res_AE, MC_net, opt_res_AE, tmp_frames, tmp_ori, config_test, args.name)
            total_bpp += clip_bpp
