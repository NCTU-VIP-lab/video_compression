...
def main(**kwargs):
    ...
    utils.load_weights_api(flow_AE, res_AE, MC_net, None, args.name)
    ...
    for path in tqdm(paths):
        ...
        for j in range(iteration):
            ...
            reconstruction_frames, example, clip_bpp, clip_actual_bits, clip_flow_bits, clip_res_bits = utils.sample_test_real_bpp(flow_AE, res_AE, MC_net, tmp_frames, tmp_ori, config_test, args.name)
            total_bpp += clip_bpp
